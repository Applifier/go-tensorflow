...
type ReloadConfigRequest struct {
	Config *ModelServerConfig `protobuf:"bytes,1,opt,name=config" json:"config,omitempty"`
}
...
func (*ReloadConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorModelManagement, []int{0}
}
...
type ReloadConfigResponse struct {
	Status *StatusProto `protobuf:"bytes,1,opt,name=status" json:"status,omitempty"`
}
...
func (*ReloadConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorModelManagement, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/model_management.proto", fileDescriptorModelManagement)
}

var fileDescriptorModelManagement = []byte{
	...
	0xd8, 0x8c, 0x0d, 0x06, 0xab, 0x08, 0x00, 0x39, 0x2f, 0x08, 0xaa, 0xdc, 0x49, 0xf8, 0xc4, 0x23,
	0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0x07,
	0x23, 0x63, 0x12, 0x1b, 0xd8, 0x0b, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x37, 0xcb, 0xe5,
	0x35, 0x52, 0x01, 0x00, 0x00,
}
