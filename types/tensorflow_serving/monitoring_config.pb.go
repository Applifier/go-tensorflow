...
func (*PrometheusConfig) Descriptor() ([]byte, []int) { return fileDescriptorMonitoringConfig, []int{0} }
...
type MonitoringConfig struct {
	PrometheusConfig *PrometheusConfig `protobuf:"bytes,1,opt,name=prometheus_config,json=prometheusConfig" json:"prometheus_config,omitempty"`
}
...
func (*MonitoringConfig) Descriptor() ([]byte, []int) { return fileDescriptorMonitoringConfig, []int{1} }
...
func init() {
	proto.RegisterFile("tensorflow_serving/monitoring_config.proto", fileDescriptorMonitoringConfig)
}

var fileDescriptorMonitoringConfig = []byte{
	...
	0x09, 0x14, 0xa0, 0x89, 0x38, 0x09, 0x9f, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83,
	0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0xfc, 0x60, 0x64, 0x4c, 0x62, 0x03, 0x7b, 0xcb, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0x91, 0x92, 0xa8, 0x97, 0x04, 0x01, 0x00, 0x00,
}
